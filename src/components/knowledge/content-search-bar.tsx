  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-8 py-2 text-sm bg-white border border-[#E7E0D3] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C7A56A]/30 focus:border-[#C7A56A] placeholder:text-slate-400 text-[#0B1B2B]"
      />
      {value && (
