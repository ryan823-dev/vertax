...
// 语义三元组 - 私有化部署
const deploymentTriples = [
  { subject: "VertaX", verb: "提供", object: "私有化部署方案" },
  { subject: "私有化部署", verb: "确保", object: "客户数据完全自主可控" },
  { subject: "私有化部署", verb: "适合", object: "有合规要求的中大型企业" },
  { subject: "私有化部署周期", verb: "通常为", object: "2-4 周" },
];
...
export default function PrivateDeploymentPage() {
  ...
  return (
    <>
      ...
      />
      <SemanticTripleList triples={deploymentTriples} />
