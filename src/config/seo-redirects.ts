...
/**
 * SEO redirect rules extracted from next.config.ts.
 * Category consolidation + product-to-category wildcards + brand catch-all.
 */
export const seoRedirects: Redirect[] = [
  ...
  // ========== Product Redirects (93 products via wildcard) ==========
  {
